...
class MainPage(webapp2.RequestHandler):
    ...
    def get(self):
        ...
        if useragent in CLIAGENTS:
            ...
            <script src="/preferences.js"></script>''' %fgcolor)
            self.response.write('''
