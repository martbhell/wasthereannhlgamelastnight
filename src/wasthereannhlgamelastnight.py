...
class MainPage(webapp2.RequestHandler):
    ...
    def get(self):
        ...
        <head><title>Was there an NHL game yesterday?')
            ...
            self.response.write('<a href="menu" title="menu"><svg xmlns="http://www.w3.org/2000/svg" width="10%" height="50%" viewBox="0 0 10% 50%" style="fill:#') # pylint: disable=line-too-long
            self.response.write(fgcolor)
