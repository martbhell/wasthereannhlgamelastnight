...
class MainPage(webapp2.RequestHandler):
    ...
    def get(self):
        ...
        <head><title>Was there an NHL game yesterday?')
            ...
            ### The menu icon to the lft
            # https://github.com/google/material-design-icons/blob/master/navigation/svg/production/ic_menu_48px.svg
            self.response.write('<svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" viewBox="0 0 120 120" style="fill:#') # pylint: disable=line-too-long
            self.response.write(fgcolor)
            self.response.write('; position: absolute; top: 0; border: 0; left: 0"><path d="M6 36h36v-4H6v4zm0-10h36v-4H6v4zm0-14v4h36v-4H6z"/></svg>') # pylint: disable=line-too-long
